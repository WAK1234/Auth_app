                ...
                <div className="mx-auto mt-20">
                    ...
                    <div className="input group">
                        <div className="border-2 h-7 border-[#79cce6] rounded-lg mt-10">
                            ...
                            <input type="text" className="text-[#79cce6] ml-7" placeholder={'Full Name'}
                    ...
                    <button className={'mt-3 w-full h-7 border-2 border-[#79cce6] rounded-lg'}><i
                        className="fa-brands fa-google custom-google-icon"></i><span className="text-[blackcd] ml-2">Sign
                      Up With google</span>
                    </button>
                    ...
                    <div className="flex flex-row">
                        ...
                        <Link to="/signi" className="mt-3 ml-3 text-[#79cce6]">Sign In</Link>
                    </div>
                </div>
            </div>
